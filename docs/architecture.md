...
For every harness, the spawn guard requires the selected path to be a linked worktree of the spawning project's repository, not merely a distinct worktree from another clone.
